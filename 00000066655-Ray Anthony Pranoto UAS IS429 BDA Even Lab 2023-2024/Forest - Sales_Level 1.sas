...
proc casutil;
  Load casdata="Forest___Sales_Level_1.sashdat" incaslib="Models" casout="Forest___Sales_Level_1" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object Forest___Sales_Level_1(astore);
call Forest___Sales_Level_1.score('CASUSER','Forest___Sales_Level_1');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'I_Sales_Level'n 'P_Sales_LevelHigh'n 'P_Sales_LevelLow'n;
length 'I_Sales_Level_9751'n $4;
      'I_Sales_Level_9751'n='I_Sales_Level'n;
'P_Sales_LevelHigh_9751'n='P_Sales_LevelHigh'n;
'P_Sales_LevelLow_9751'n='P_Sales_LevelLow'n;
   /*------------------------------------------*/
";
